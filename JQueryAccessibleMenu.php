...
function JQueryAccessibleMenu_init() {
    ...
    if ( !is_admin() && is_active_widget('widget_JQueryAccessibleMenu') ) {
        wp_register_style('jquery.ui.all', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleMenu/lib/jquery-ui/themes/base/jquery.ui.all.css'));
        wp_enqueue_style('jquery.ui.all');

        wp_deregister_script('jquery');

        // add your own script
        wp_register_script('jquery-1.4.2', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleMenu/lib/jquery-ui/jquery-1.4.2.js'));
        wp_enqueue_script('jquery-1.4.2');

        wp_register_script('jquery.ui.core.js', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleMenu/lib/jquery-ui/ui/jquery.ui.core.js'));
        wp_enqueue_script('jquery.ui.core.js');

        wp_register_script('jquery.ui.widget', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleMenu/lib/jquery-ui/ui/jquery.ui.widget.js'));
        wp_enqueue_script('jquery.ui.widget');

        wp_register_script('jquery.ui.position', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleMenu/lib/jquery-ui/ui/jquery.ui.position.js'));
        wp_enqueue_script('jquery.ui.position');

        wp_register_script('jquery.ui.button', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleMenu/lib/jquery-ui/ui/jquery.ui.button.js'));
        wp_enqueue_script('jquery.ui.button');

        wp_register_script('jquery.ui.menu', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleMenu/lib/jquery-ui/ui/jquery.ui.menu.js'));
        wp_enqueue_script('jquery.ui.menu');

        wp_register_style('demos', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleMenu/lib/jquery-ui/demos.css'));
        wp_enqueue_style('demos');

        wp_register_script('JQueryAccessibleMenu', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleMenu/lib/JQueryAccessibleMenu.js'));
